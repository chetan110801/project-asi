...
- **The reader:** `py -3 build_site.py` compiles `LEARNING/**/*.md` into one self-contained offline `agi-paths.html`. Rebuild it after any content change. Verify reader changes in headless Chrome, not by eye.
