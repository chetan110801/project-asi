...
- **The reader:** `py -3 build_site.py` compiles `LEARNING/**/*.md` into one self-contained offline `approaches-to-agi.html`. Rebuild it after any content change. Verify reader changes in headless Chrome, not by eye.
