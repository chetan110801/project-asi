...
│
├── REVIEWS/                   ← self-critiques / audits (drives version upgrades)
│   └── AUDIT_2026-06-20_v1.0.md
│
└── (folders created later as the work grows)
    ├── DOMAINS/      ← one folder per field we study (AI, neuroscience, energy…)
    ├── RESOURCES/    ← notes on specific books, papers, talks
...
*Status: Living system · Version 0.1 · Last updated: 2026-06-20*
