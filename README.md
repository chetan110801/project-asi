...
├── agi-paths.html             ← the built offline reader (open this to read) — `py -3 build_site.py`
├── build_site.py              ← builds agi-paths.html from LEARNING/**/*.md
...
- **Want to read the investigation?** Open [`agi-paths.html`](agi-paths.html), or start at [`LEARNING/APPROACHES_TO_AGI.md`](LEARNING/APPROACHES_TO_AGI.md).
