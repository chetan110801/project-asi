...
- **The ideas it leads to** (still to be written): AP6 (brain-based — the brain is *also* said to be a constant prediction machine, a biological world model), AP3 (agents — a world model is the "planning" part of a full agent), and AP10 (embodiment — a body is how a machine would gather the sensory experience AP5 needs). See the [map](../APPROACHES_TO_AGI.md).
