...
- **▶ Go deeper (deep dive):** [#1 · the engine](../50-deep-dives/04_ap4-deep-dive-the-engine.md) — the machine beneath this card's "trial and error": **temporal-difference learning** (learn "a guess from a guess"; the **TD error = surprise** that solves credit assignment, and the **dopamine** signal that matches it), **value-based vs policy-based** methods and the **actor-critic** workhorse (**PPO**), **model-free vs model-based** RL (**MuZero**; *why* RL is sample-hungry, handed on to [AP5](05_ap5-world-models-jepa.md)), and how this engine trains 2026's models (**RLHF/PPO → verifiable-reward/GRPO**). The optional layer past this card.
