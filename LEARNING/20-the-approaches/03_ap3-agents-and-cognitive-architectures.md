...
- **The ideas it leads to:** [AP4 · RL from interaction](04_ap4-rl-from-interaction.md) gives the *reward-driven* version of the agent — an agent that learns its loop from reward in a world, rather than being scripted; [AP7 · neurosymbolic](07_ap7-neurosymbolic-and-hybrid-ai.md) (now written) and AP9 (open-endedness, still ahead) bear on how an agent could *plan* and *keep learning* reliably. See the [map](../APPROACHES_TO_AGI.md).
