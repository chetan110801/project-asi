...
- **The ideas it leads to** (still to be written): AP11 (whole-brain emulation — copy the brain *neuron by neuron* instead of extracting its algorithm — the more literal, more extreme cousin), AP10 (embodiment — the brain's "learning via movement" needs a body), and the alignment thread. See the [map](../APPROACHES_TO_AGI.md).
