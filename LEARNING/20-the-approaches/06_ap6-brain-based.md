...
- **The ideas it leads to:** now written — [AP10 · embodiment](10_ap10-embodiment.md) (the brain's "learning via movement" needs a body — AP10 is its deep home); still to be written — AP11 (whole-brain emulation — copy the brain *neuron by neuron* instead of extracting its algorithm — the more literal, more extreme cousin) and the alignment thread. See the [map](../APPROACHES_TO_AGI.md).
