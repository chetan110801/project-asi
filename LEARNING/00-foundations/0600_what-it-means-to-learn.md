...
- **Guard the objective.** A system gets *exactly* what you measure, which is rarely what you meant — a misspecified objective produces **reward hacking** / Goodhart's law (the metric is gamed while the goal fails; recall the feedback-signal warning at [0250](0250_feedback-loops-and-control.md), revisited as alignment at [1900](../50-frontier-and-alignment/)). Choosing the objective is a safety decision, not just a technical one.
