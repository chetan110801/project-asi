...
1. **It processes the whole sequence in parallel** → it maps perfectly onto GPUs ([0350](../30-math-and-theory/0350_just-enough-linear-algebra.md)/[1400](../40-compute-and-infrastructure/)) → it could be trained on far more data.
...
- **Leads to:** scaling laws ([1700](../20-machine-intelligence/)), the compute & data that train them ([1400](../40-compute-and-infrastructure/)/[1600](../40-compute-and-infrastructure/)), paths to AGI and whether scaling LLMs suffices ([1800](../50-frontier-and-alignment/)), and alignment/interpretability of the systems we now deploy at scale ([1900](../50-frontier-and-alignment/)).
...
---
*Concepts introduced → logged in [CONCEPT_REGISTRY](../CONCEPT_REGISTRY.md). Announced in [WHATS_NEW](../WHATS_NEW.md). This closes the machine-intelligence **core** (1000→1300). The ladder now turns to what powers it all — compute & chips ([1400](../40-compute-and-infrastructure/)), data ([1600](../40-compute-and-infrastructure/)), and scaling laws ([1700](../20-machine-intelligence/)) — then the frontier: paths to AGI ([1800](../50-frontier-and-alignment/)) and alignment ([1900](../50-frontier-and-alignment/)).*
