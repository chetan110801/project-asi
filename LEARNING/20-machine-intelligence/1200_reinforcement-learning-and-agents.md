...
- **Leads to:** RLHF and LLM agents ([1300](1300_language-models-the-next-token-idea.md)), robotics & embodiment ([1800](../50-frontier-and-alignment/)), world models and paths to AGI ([1800](../50-frontier-and-alignment/)), and the alignment of goal-seeking systems ([1900](../50-frontier-and-alignment/)).
...
---
*Concepts introduced → logged in [CONCEPT_REGISTRY](../CONCEPT_REGISTRY.md). Announced in [WHATS_NEW](../WHATS_NEW.md). Next, the chapter's payoff: how large language models actually work ([1300](1300_language-models-the-next-token-idea.md)) — where prediction, the transformer, and RLHF all meet.*
