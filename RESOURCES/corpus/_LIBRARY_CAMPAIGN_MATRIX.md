...
- ⬜ Remaining: developmental biology (lower priority). **[Session-12: genetics filled. Session-13: computational-biology + immunology filled.]**
...
- ⬜ Remaining: transportation; deeper water-resources (lower priority). **[Session-11: structural analysis. Session-12: geotechnical/foundation. Session-13: hydraulics/open-channel-flow filled.]**
...
- ⬜ Remaining: dedicated propulsion text (lower priority). **[Session-11: aerodynamics + aircraft performance + flight-vehicles. Session-13: orbital mechanics/astrodynamics filled.]**
...
- **Session 14+ — continue exhaustion (recover 4 8.701 clips · 3rd L4 batch if thin · deep-tail gap courses · residual ⬜ books · OCR the 3 scans) → pause for the learner's "rich enough" call → first grounded module rewrite (1300 LLMs).**
