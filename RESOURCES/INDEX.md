...
| `r-mml` | Mathematics for Machine Learning — Deisenroth, Faisal, Ong | [mml-book.github.io](https://mml-book.github.io/) | ✅ free PDF |
...
| `r-boyd-cvx` | Convex Optimization — Boyd & Vandenberghe | [stanford.edu/~boyd](https://web.stanford.edu/~boyd/cvxbook/) | 🟢? free PDF |
...
| `r-goodfellow-dl` | Deep Learning — Goodfellow, Bengio, Courville | [deeplearningbook.org](https://www.deeplearningbook.org/) | ✅ free (read) |
...
| `r-sutton-barto` | Reinforcement Learning: An Introduction (2nd ed) — Sutton & Barto | [incompleteideas.net](http://incompleteideas.net/book/the-book-2nd.html) | 🟢? free draft |
...
| `r-aima` | AI: A Modern Approach — Russell & Norvig | [aima.cs.berkeley.edu](https://aima.cs.berkeley.edu/) | 📘 book (resources free) |
...
| `r-kandel` | Principles of Neural Science — Kandel et al. | (Cambridge/McGraw-Hill) | 📘 need to obtain |
